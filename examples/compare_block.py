...
# Beautified compare-plot function (inspired by plot_block_results in utils.py)
...
def save_all_results(algorithms, dt, x0=None, xg=None, base_dir="results", filename="all_algorithms_solution.npz"):
    """
    Save all algorithm results into a single .npz file.
    The file contains keys of the form:
      <sanitized_name>_xbar, <sanitized_name>_ubar, <sanitized_name>_Vstore
