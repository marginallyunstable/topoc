...
dynamics = partial(pendulum_with_friction, params=params_dynamics)
...
plot_compare_pendulum_results(algorithms, x0, xg, modelparams, friction_thresh=-5.0)
...
def save_all_results(algorithms, dt, x0=None, xg=None, base_dir="results", filename="pendulum_with_friction_solution.npz"):
    """
    Save all algorithm results into a single .npz file.
    The file contains keys of the form:
      <sanitized_name>_xbar, <sanitized_name>_ubar, <sanitized_name>_Vstore
